...
const actualColors = {
  ...
  "background_surface-warning": "#FDF0C8",
  "background_surface-warning-strong": "color-mix(in srgb, #E2B018, white 70%)",
  ...
  "core-metabase_brand-hover": baseColors.brand[30],
  ...
  "input-focus": baseColors.brand[20],
